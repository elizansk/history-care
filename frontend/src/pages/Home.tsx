...
const directions = [
  {
    title: 'Исторические дома',
    text: 'Деревянные усадьбы, первые городские постройки и здания, с которыми связана история жителей.',
  },
  {
    title: 'Храмы и памятники',
    text: 'Архитектурные символы городов: часовни, церкви, мемориальные здания и объекты культурного наследия.',
  },
  {
    title: 'Общественные пространства',
    text: 'Музеи, речные вокзалы, культурные центры и другие места, которые сохраняют память о городе.',
  },
];
        ...
        <section className="home-hero">
          ...
          <div className="home-hero-content">
            ...
            <p className="home-hero-text">
              ...
              а неравнодушные люди помогают объектам быть отремонтированными.
            </p>
